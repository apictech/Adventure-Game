...
def intro():
    print_sleep("You find yourself standing in an open area, filled with grass and yellow wildflowers.")
...
def house():
    ...
    if "sword" in items:
        ...
        print_sleep(f"You have rid the town of the {demon}. You are victorious!")
        restart_game()
